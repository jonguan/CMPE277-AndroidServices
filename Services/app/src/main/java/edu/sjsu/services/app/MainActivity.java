...
public class MainActivity extends ActionBarActivity {
    ...
    public void onDownloadPDF (View view) {
        ...
        LogUtil.appendLog(this, "Transitioning to pdf download activity");
    ...
    public void onDownloadImage (View view) {
        ...
        LogUtil.appendLog(this, "Transitioning to image download activity");
        startActivity(intent);
    }

    public void onDownloadText (View view) {
        Intent intent = new Intent(this, TextDownloadActivity.class);
        LogUtil.appendLog(this, "Transitioning to text download activity");
        startActivity(intent);
    }
